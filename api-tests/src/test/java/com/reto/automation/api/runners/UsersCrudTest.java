...
/**
 * Runner dedicado a users_crud.feature (CA-API-02).
 * Sigue el mismo patrón que RegresionApiTest; si se necesita filtrar por
 * tag en una corrida puntual, se agrega igual que ahí:
 * {@code @ConfigurationParameter(key = Constants.FILTER_TAGS_PROPERTY_NAME, value = "@Negative")}
 */
@Suite
@IncludeEngines("cucumber")
@SelectClasspathResource("features/api/users_crud.feature")
