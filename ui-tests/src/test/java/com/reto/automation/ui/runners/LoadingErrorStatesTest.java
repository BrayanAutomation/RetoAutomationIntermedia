...
/**
 * Runner dedicado a loading_error_states.feature (CA-UI-03, integra BUG-API-001).
 * Sigue el mismo patrón que RegresionUiTest.
 */
@Suite
@IncludeEngines("cucumber")
@SelectClasspathResource("features/ui/loading_error_states.feature")
...
public class LoadingErrorStatesTest {
}
