...
/**
 * Runner dedicado a app_load.feature (CA-UI-01).
 * Sigue el mismo patrón que RegresionUiTest; si se necesita filtrar por
...
@SelectClasspathResource("features/ui/app_load.feature")
